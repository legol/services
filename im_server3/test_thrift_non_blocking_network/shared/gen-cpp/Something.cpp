...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > SomethingProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< SomethingIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< SomethingIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new SomethingProcessor(handler));
  return processor;
}
